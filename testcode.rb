...
mex_cuisine.print_recipe(burrito)

enchilada = Recipe.new("Cheese Enchilada", ["tortilla", "cheese", "queso blanco", "jalapenos"], ["simmer onions, tomatoes, peppers", "roll in tortilla", "cover with queso blanco and jalapenos"])
mex_cuisine.add_recipe(enchilada)

mex_cuisine.print_recipe(enchilada)